...
import { Menu, X, Search, Phone, ChevronDown, MessageCircle } from 'lucide-react';
      ...
      <header className="fixed top-0 left-0 right-0 z-50 px-4 pt-3">
        <nav
          className={clsx(
            ...
            scrolled
              ? 'bg-saona-navy/95 shadow-2xl shadow-black/30'
              : 'bg-saona-navy/80',
            'backdrop-blur-md border border-white/8 rounded-2xl px-4 py-2.5'
          )}
        >
          <div className="flex items-center gap-3">
            ...
            <div className="hidden md:flex items-center gap-1 flex-1">
              ...
              <Link
                ...
                className={clsx(
                  ...
                  isActive('/pintame')
                    ? 'bg-saona-blue/30 border-saona-blue/50 text-blue-300'
                    : 'bg-saona-blue/15 border-saona-blue/30 text-blue-300 hover:bg-saona-blue/25'
                )}
              >
                🎨 Píntame
              </Link>
            ...
            <div className="flex items-center gap-2 ml-auto">
              ...
              <a
                ...
                className="hidden lg:flex items-center gap-1.5 text-white/50 hover:text-white/80 text-xs transition-colors"
              >
                <Phone className="w-3 h-3" />
                +51 981 272 614
              </a>

              {/* Cotiza aquí — always visible */}
              <a
                href={whatsappUrl}
                target="_blank"
              ...
              {/* Mobile menu button */}
              <button
                className="md:hidden text-white/70 hover:text-white p-1.5 rounded-lg hover:bg-white/8 transition-colors"
          ...
          {/* Mobile menu */}
          {isOpen && (
            <div className="md:hidden mt-2 pt-3 border-t border-white/8">
              <div className="flex flex-col gap-1 pb-2">
                ...
                <Link
                  href="/pintame"
                  onClick={() => setIsOpen(false)}
                  className="flex items-center gap-2 px-3 py-2.5 rounded-xl text-sm font-semibold text-blue-300 bg-saona-blue/15 border border-saona-blue/30"
                >
                  🎨 Píntame
                </Link>
                <div className="pt-2 border-t border-white/8 mt-1">
                  <a
                    href="tel:+51981272614"
                    className="flex items-center gap-2 px-3 py-2 text-white/40 text-sm"
                  >
